...
class DataCleaner:
    ...
    def get_recommendations(df: pd.DataFrame) -> Dict[str, List[Dict]]:
        ...
        recommendations = {"missing": [], "outliers": [], "duplicates": [], "type_conversions": []}
        ...
        for col in df.select_dtypes(include=[np.number]).columns:
            ...
            if outlier_count > len(df) * 0.05:
                recommendations["outliers"].append({
                    ...
                    "action": "clip_iqr", "priority": "medium"
                })
    ...
    def handle_outliers(df: pd.DataFrame, method: str = "clip_iqr",
        ...
        for col in columns:
            ...
            if method == "clip_iqr":
                ...
                log["outliers_treated"] += int(outlier_mask.sum())
                ...
                log["outliers_treated"] += before - len(df)
